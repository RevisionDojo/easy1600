...
function convertCollegeBoardQuestions() {
  ...
  for (const question of data.questions || []) {
    ...
    const answerChoices = question.answer_type === 'mcq' && question.answer_choices ?
      JSON.stringify(question.answer_choices) : null;
    const correctChoice = question.answer_choices?.find(c => c.is_correct)?.letter || null;
    const sprAnswers = question.answer_type === 'spr' && question.spr_answers ?
      JSON.stringify(question.spr_answers) : null;
